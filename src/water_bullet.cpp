...
Water_Bullet::Water_Bullet(float x, float y, color_t color) {
    this->position = glm::vec3(x, y, 0);
    this->velocity = glm::vec3((0.3/10), (0.3/10), 0);
    ...
    this->object1 = create3DObject(GL_TRIANGLES, n*3, vertex_buffer_data0, COLOR_BLUE, GL_FILL);
}

void Water_Bullet::draw(glm::mat4 VP) {
...
void Water_Bullet::set_position(float x, float y) {
    this->position = glm::vec3(x, y, 0);
}

void Water_Bullet::tick() {
    this->motion();
